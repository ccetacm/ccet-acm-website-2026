  ...
  const coreActivities = [
    {
      ...
      description: "Cross-border collaboration and funding in fostering innovation and research excellence.",
      link: "#/icrg",
      category: "Research"
    },
    {
      ...
      description: "Code for Cause unites technology and NGOs to tackle pressing social issues.",
      link: "#/code-for-cause",
    ...
    },
    {
      ...
      description: "Engaging conversations with tech experts to inspire and inform the community.",
    ...
    },
    {
      ...
      description: "Empowering developers with coding skills for leading technology companies.",
    ...
    },
    {
      ...
      description: "Exploring strategic pathways to internships and meaningful career opportunities.",
    ...
    },
    {
      ...
      title: "Healthy Byte",
      description: "Empowering you with essential digital wellness skills for a healthier tomorrow.",
      link: "#healthy-byte",
      category: "Wellness"
    },
  ];
        ...
        <div className={styles.container}>
          <header className={styles.header}>
            ...
            <p className={styles.subtitle}>
              Discover our comprehensive range of programs designed to empower, educate, and inspire
            </p>
          </header>
