  ...
  return (
    <div className="testimonials-container">
      <div className="header">
        ...
        <p className="subtitle">Discover how ACM has transformed careers and fostered innovation through the voices of our community members.</p>
      </div>

      <div className="carousel-container" ref={containerRef} onMouseEnter={stopAutoPlay} onMouseLeave={startAutoPlay}>
        <div className="carousel-wrapper">
          <button className="nav-button prev" aria-label="Previous testimonial" onClick={prevSlide}>
            ‹
          </button>
          ...
          <button className="nav-button next" aria-label="Next testimonial" onClick={nextSlide}>
            ›
          </button>
        </div>
      </div>
