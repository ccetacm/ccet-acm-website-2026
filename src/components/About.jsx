    ...
    <>
      {/* Navigation */}
            <nav className="navbar" id="navbar">
              <div className="nav-container">
                ...
                <div className="nav-menu" id="nav-menu" style={{ display: "flex" }}>
                  ...
                  <a href="#casc" className="nav-link">CASC</a>
                ...
                <div className="hero-content">
                  <div className="hero-text fade-in-up">
                    ...
                    <p className="hero-subtitle">
                      CCET ACM Student Chapter - Building a community of innovators, creators, and technology enthusiasts who shape the future of computing.
                    </p>
                    <div className="hero-buttons">
                      <a href="#about" className="btn btn-primary">Discover More</a>
                      <a href="#teams" className="btn btn-secondary">Our Teams</a>
                    </div>
                  </div>
                  <div className="hero-visual fade-in-right">
                    <div className="acm-logo-display">
                      <img src="src/assets/acm-diamond-logo.png" alt="ACM Logo" className="acm-diamond-logo" />
                    </div>
                  </div>
                </div>
              </div>
                  ...
                  <div className="about-text">
                    <div className="content-card slide-in-left">
                      <p className="lead-text">
                        The Association for Computing Machinery (ACM) is an international learned society for computing. Founded in 1947, it serves as an umbrella organization for academic and scholarly interests in computer science.
                      </p>
                    </div>
                  </div>
                    ...
                    <div className="stats-card slide-in-up">
                      <div className="stats-grid">
                        <div className="stat-item">
                          <span className="stat-number" data-target="100000">0</span>
                          <span className="stat-label">Members Worldwide</span>
                        </div>
                        <div className="stat-item">
                          <span className="stat-number" data-target="1947">0</span>
                  ...
                  <div className="about-features">
                    <div className="feature-grid">
                      <div className="feature-card slide-in-up" data-delay="100">
                        ...
                        <p>100,000+ members worldwide working together to advance computing</p>
                      </div>
                ...
                <div className="casc-content">
                  <div className="casc-intro slide-in-right">
                    <div className="content-card">
                      <p className="lead-text">
                        CCET ACM Student Chapter believes in providing a healthy environment where creativity and imagination can flourish. Through collaboration and engagement in technical activities and projects, we envision building a community of like-minded people who love to code, collaborate and have fun!
                      </p>
                    </div>
                  </div>
                  <div className="mission-vision-grid">
                    <div className="mission-card slide-in-left">
                      ...
                      <p>Driving innovation and excellence in computing through education, research, and global collaboration.</p>
                    </div>
                    <div className="mission-vision-row">
                      <div className="mission-card slide-in-up">
                        ...
                        <p>To advance the field of computing and empower individuals within it, promoting innovation and excellence in computing education, research, and practice.</p>
                      </div>
                      <div className="mission-card slide-in-right">
                        ...
                        <p>To be at the forefront of shaping the future of computing, fostering a dynamic global community where interdisciplinary collaboration thrives.</p>
                      </div>
                    </div>
                    <div className="plan-card-center">
                      <div className="mission-card slide-in-up" data-delay="200">
                        ...
                        <p>Drive the future of computing by fostering interdisciplinary collaboration, advocating for ethical and responsible technology development.</p>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <section id="department" className="department section">
              <div className="container">
                <div className="section-header text-center">
                  <h2 className="section-title">Department of Computer Science & Engineering</h2>
                ...
                <div className="department-content">
                  <div className="department-about slide-in-left">
                    <div className="content-card">
                      <h3>About Us</h3>
                      <p>The Computer Science and Engineering Department at Chandigarh College of Engineering and Technology (CCET) is committed to delivering world-class education, fostering innovation, and nurturing skilled professionals in the field of computing and technology.</p>
                      <p>With a strong emphasis on academic excellence and practical learning, the department offers a robust curriculum, state-of-the-art facilities, and opportunities for research and development.</p>
                      <a href="https://ccet.ac.in/CSE-overview.php" className="btn btn-outline" target="_blank" rel="noopener noreferrer">
                  ...
                  <div className="department-goals">
                    <div className="goal-card slide-in-right">
                      ...
                      <p>To produce self-motivated and globally competent technocrats equipped with computing, innovation, and human values for ever changing world and shape them towards serving the society.</p>
                    </div>
                ...
                <div className="teams-grid">
                  <div className="team-card slide-in-left">
                    ...
                    <div className="team-content">
                      ...
                      <p>The main chapter focused on advancing computing education, research, and fostering a community of technology enthusiasts and innovators.</p>
                  ...
                  <div className="team-card slide-in-right">
                    ...
                    <div className="team-content">
                      ...
                      <p>Dedicated to supporting, celebrating, and advocating for women in computing, creating an inclusive environment for all to thrive in technology.</p>
                      <div className="team-features">
                ...
                <div className="footer-content">
                  ...
                  <div className="footer-section">
                    ...
                    <ul>
                      ...
                      <li><a href="#" target="_blank" rel="noopener noreferrer">Magazine</a></li>
                      <li><a href="#" target="_blank" rel="noopener noreferrer">Achievements</a></li>
                    </ul>
                  </div>
                  <div className="footer-section">
                    <h4>Connect</h4>
...
/* ==============================
   JS functions (modified initProgramOutcomes)
============================== */
