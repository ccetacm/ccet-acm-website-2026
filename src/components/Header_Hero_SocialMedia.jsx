    ...
    return (
      ...
      `}</style>
        ...
        * {
        ...
        .nav-links a:hover {
            color: var(--zaffre);
            text-shadow: 0 0 15px rgba(3, 19, 166, 0.8), 0 0 25px rgba(52, 237, 243, 0.4);
        ...
        .nav-links a::after {
            ...
            width: 0;
            height: 2px;
            background: linear-gradient(90deg, var(--zaffre), var(--fluorescent-cyan));
        ...
        .nav-links a::before {
            ...
            border-radius: 8px;
            background: linear-gradient(45deg, transparent, rgba(52, 237, 243, 0.1), transparent);
            opacity: 0;
        ...
        .main-title {
            ...
            letter-spacing: -4px;
            text-shadow: 
                4px 4px 0px rgba(226, 232, 240, 0.8),
                8px 8px 0px rgba(203, 213, 225, 0.6),
                12px 12px 0px rgba(148, 163, 184, 0.4),
        ...
        .ccet-text {
            ...
            animation: titleFloat 6s ease-in-out infinite, slideInCCET 1.2s ease-out 0.3s forwards;
        }
        ...
        .acm-text {
            ...
            animation: titleFloat 6s ease-in-out infinite, slideInACM 1.5s ease-out 0.8s forwards;
        }
        ...
        .student-chapter-text {
            ...
            opacity: 0;
            transform: translateX(50px) translateY(-20px);
            animation: titleFloat 6s ease-in-out infinite, slideInStudent 1.2s ease-out 1.5s forwards;
        }
        ...
        @keyframes slideInACM {
            0% {
                opacity: 0;
                transform: scale(0.5) rotateY(90deg) perspective(500px) rotateX(15deg);
            }
            50% {
                opacity: 0.5;
                transform: scale(0.8) rotateY(45deg) perspective(500px) rotateX(15deg);
            }
            100% {
                opacity: 1;
      ...
      `}</style>
            ...
            <div style={{ background: 'white', color: 'var(--oxford-blue)' }}>
                ...
                <div className="social-sidebar">
                    <a href="https://www.facebook.com/acmccet/" target="_blank" rel="noopener noreferrer" className="social-icon facebook" aria-label="Facebook">
                        <i className="fab fa-facebook-f"></i>
                    </a>
                    <a href="https://www.instagram.com/acmccet/?hl=en" className="social-icon instagram" target="_blank" rel="noopener noreferrer" aria-label="Instagram">
                        <i className="fab fa-instagram"></i>
                    </a>
                    <a href="https://in.linkedin.com/company/ccet-acm-student-chapter" className="social-icon linkedin" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn">
                        <i className="fab fa-linkedin-in"></i>
                    </a>
                    <a href="https://x.com/acmccet" className="social-icon twitter" target="_blank" rel="noopener noreferrer" aria-label="Twitter">
