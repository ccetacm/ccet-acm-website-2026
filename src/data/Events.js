...
export const events = [
    ...
    },
    {
        ...
        difficulty: "Beginner",
        groupSize: "50+ Students",
        background: "/Events/WordpressWorkshop/WordpressWorkshop1.jpg",
        cardImage: "https://images.unsplash.com/photo-1432888622747-4eb9a8efeb07?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&q=80",
        images: [
            "/Events/WordpressWorkshop/WordpressWorkshop1.jpg",
            "/Events/WordpressWorkshop/WordpressWorkshop2.jpg",
            "/Events/WordpressWorkshop/WordpressWorkshop3.jpg",
            "/Events/WordpressWorkshop/WordpressWorkshop4.jpg",
            "/Events/WordpressWorkshop/WordpressWorkshop5.jpg",
            "/Events/WordpressWorkshop/WordpressWorkshop6.jpg"
        ],
        reactions: {
            "❤️": { count: 23, text: "people loved attending this workshop" },
            "😊": { count: 18, text: "people enjoyed this workshop" },
            "👍": { count: 31, text: "people found this workshop helpful" },
            "😢": { count: 5, text: "people regret missing this workshop" },
            "🎯": { count: 27, text: "people learned a lot from this workshop" }
        }
    },
    {
        title: "ORIENTATION",
        location: "August 20, 2024",
        description: "CCET's ACM Chapter orientation featured insightful talks and engaging interactive challenges and insights from Sahil Garg and Ayushi, inspiring tech passion and skill development. New members were introduced to the chapter's mission, upcoming events, and opportunities for growth in the technology field.",
        duration: "Half Day",
        difficulty: "Easy",
        groupSize: "100+ Students",
        background: "/Events/Orientation/Orientation1.jpg",
        cardImage: "https://images.unsplash.com/photo-1517245386807-bb43f82c33c4?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&q=80",
        images: [
            "/Events/Orientation/Orientation1.jpg",
            "/Events/Orientation/Orientation2.jpg",
            "/Events/Orientation/Orientation3.jpg",
            "/Events/Orientation/Orientation4.jpg",
            "/Events/Orientation/Orientation5.jpg",
            "/Events/Orientation/Orientation6.jpg"
        ],
        reactions: {
            "❤️": { count: 45, text: "people loved this orientation" },
            "😊": { count: 38, text: "people enjoyed the orientation" },
            "👍": { count: 52, text: "people found this orientation helpful" },
            "😢": { count: 12, text: "people regret missing this event" },
            "🎯": { count: 29, text: "people were inspired by this session" }
        }
    },
    {
        ...
        difficulty: "Beginner",
        groupSize: "52 Students",
        background: "/Events/IntroductionToC_CPP/1.jpg",
        cardImage: "/Events/IntroductionToC_CPP/2.jpg",
        images: [
            "/Events/IntroductionToC_CPP/1.jpg",
            "/Events/IntroductionToC_CPP/3.jpg",
            "/Events/IntroductionToC_CPP/4.jpg",
            "/Events/IntroductionToC_CPP/5.jpg"
        ],
        reactions: {
            "❤️": { count: 20, text: "participants loved learning C/C++ basics" },
            "😊": { count: 18, text: "students enjoyed the interactive session" },
...
export const competitions = [
    {
        ...
        description: "ByteBrawl was a fast-paced coding challenge designed to test participants' skills in algorithms and data structures under a strict 60-minute limit. Competitors tackled multiple problem-solving tasks, demonstrating logic, efficiency, and speed. Winners were awarded certificates and cash prizes for their exceptional performance.",
        duration: "1 Hour",
        difficulty: "Advanced",
        groupSize: "150+ Participants",
        background: "/Events/Apratim-ByteBrawl/ByteBrawl.jpeg",
        cardImage: "/Events/Apratim-ByteBrawl/ByteBrawl.jpeg",
        images: ["/Events/Apratim-ByteBrawl/ByteBrawl.jpeg"],
        reactions: {
            "❤️": { count: 67, text: "participants loved the challenge" },
            "😊": { count: 43, text: "participants enjoyed competing" },
            "👍": { count: 89, text: "participants found it very challenging" },
            "😢": { count: 25, text: "people regret missing this competition" },
            "🎯": { count: 54, text: "participants improved their coding skills" }
        }
    },
    {
        title: "CONQUEROR'S CLASH BGMI TOURNAMENT",
        location: "Nov 12, 2024",
        description: "The Conqueror's Clash BGMI tournament featured teams of four competing online for a ₹5000 prize pool. Teams demonstrated strategic gameplay, coordination, and map knowledge across multiple intense matches. Live streaming, leaderboards, and elimination rounds made it an exhilarating experience for players and viewers alike.",
        duration: "4 Hours",
        difficulty: "Competitive",
        groupSize: "200+ Players",
        background: "/Events/Apratim-BGMI/ClashBGMI.jpeg",
        cardImage: "/Events/Apratim-BGMI/ClashBGMI.jpeg",
        images: ["/Events/Apratim-BGMI/ClashBGMI.jpeg"],
        reactions: {
            "❤️": { count: 156, text: "players loved the tournament" },
            "😊": { count: 134, text: "players enjoyed the competition" },
            "👍": { count: 178, text: "players found it incredibly exciting" },
            "😢": { count: 42, text: "people regret missing this tournament" },
            "🎯": { count: 98, text: "teams showed amazing teamwork" }
        }
    },
    {
        title: "DESIGN SCAPE",
